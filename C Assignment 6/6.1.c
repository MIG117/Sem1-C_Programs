/*
6.1 WAP to enter 3 subjects marks of 3 students in an array and display individually
 of each students - > total marks , percentage ,and grade
...
void input()
{
	...
	printf("Enter Marks of 3 Students of 3 Subjects\n");
	for(i=0;i<3;i++)
	{
